...
// import DoctorSection from "./"; // Import DoctorSection
...
function Home() { 
  ...
  return (
    <>
      ...
      <Helmet>
        {/* Primary Meta Tags */}
        <title>KKYadav Interior Work | Professional POP, Gypsum & Painting Services</title>
        <meta name="title" content="K.K. Yadav Interior Work | Professional POP, Gypsum & Painting Services" />
        <meta name="description" content="KKYadav provides quality POP, gypsum, false ceiling, partition and painting work for homes, shops and offices. Get professional interior design services at fair prices." />
        <meta name="keywords" content="interior work, POP design, gypsum ceiling, false ceiling, painting work, home interior, office interior, K.K. Yadav, partition work, POP installation" />
        <meta name="author" content="KKYadav Interior Work" />
        ...
        <meta property="og:url" content="https://kkyadavinterior.com/" />
        <meta property="og:title" content="K.K. Yadav Interior Work | Professional POP, Gypsum & Painting Services" />
        <meta property="og:description" content="Professional interior work services including POP design, gypsum ceiling, false ceiling, partition, and painting. Quality work at fair prices for homes, shops and offices." />
        <meta property="og:image" content="https://images.pexels.com/photos/1643383/pexels-photo-1643383.jpeg" />
        
        {/* Twitter Meta Tags */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://kkyadavinterior.com/" />
        <meta property="twitter:title" content="K.K. Yadav Interior Work | Professional POP, Gypsum & Painting Services" />
        <meta property="twitter:description" content="Quality interior work services for homes, shops and offices. POP design, gypsum ceiling, false ceiling, partition and painting at fair prices." />
        <meta property="twitter:image" content="https://images.pexels.com/photos/1643383/pexels-photo-1643383.jpeg" />
        
        {/* Canonical URL */}
        <link rel="canonical" href="https://kkyadavinterior.com/" />
      ...
      <div className="w-full">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <img
                ...
                alt="Interior Work 1 - Modern home interior design"
                className="rounded-xl object-cover w-full h-[300px] -mb-[40px]"
              />
              <img
                src="https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg"
                alt="Interior Work 2 - Professional office interior"
        ...
        {/* Doctor Section - Dr. Ankush Garg */}
        {/* <DoctorSection /> */}

        {/* Start Your Interior Work Section */}
